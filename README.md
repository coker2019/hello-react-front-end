...
[Hello react frontend] Is an api that generates random greetings.


This app  consumes this Api :<a name="Api">https://github.com/coker2019/hello-rails-back-end/tree/hello-rails-backend</a>
...
git@github.com:coker2019/hello-react-front-end.git
